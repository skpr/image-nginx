...
func main() {
	...
	tests := []Test{
		...
		// Test for header: X-XSS-Protection.
		hasResponseHeader("http://127.0.0.1:8080", "X-XSS-Protection"),
		hasResponseHeader("http://127.0.0.1:8080/index.PHP", "X-XSS-Protection"),
		// Blocking rules.
